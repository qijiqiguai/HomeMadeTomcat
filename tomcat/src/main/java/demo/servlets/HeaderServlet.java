 ...
 *
 * @author wangqi
 * @date 2017/9/26 下午6:59
 */
public class HeaderServlet implements Servlet {
    @Override
    ...
    public void service(ServletRequest servletRequest, ServletResponse servletResponse) throws ServletException, IOException {
        ...
        System.out.println("In HeaderServlet Service");
        PrintWriter writer = servletResponse.getWriter();

        String message = HttpUtil.okWrapper("Header Servlet: " + servletRequest.getParameterNames());
